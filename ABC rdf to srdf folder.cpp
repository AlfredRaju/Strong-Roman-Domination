...
vector<int> labelGraph_4(const std::vector<std::vector<int>>& G) {              //rdf to srdf
...
int main() {
    // Set the folder path
    std::string folder_path = "C:\\Users\\alfre\\OneDrive\\Desktop\\phd\\Graphs\\New folder1";
    ...
    // });
        ...
        //     // std::cout << x << " ";
        // }
        std::cout  << entry.path().filename() << " " << min_fitness << std::endl;  // min_fitness for rdf to srdf && best_source.fitness for heuristic3
    }
